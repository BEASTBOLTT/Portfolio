...
function SideBar({menuActive, handleExplorer, explorerActive}) {
    return (
        menuActive
            ? <div className="bg-[#323233] h-full w-18 " >
                <svg onClick={handleExplorer} className={explorerActive ? "h-15 w-15 p-1 pl-1 bg-[#252526] m-1 rounded-2xl" : "h-15 w-15 p-1 pl-1 m-1 rounded-2xl"} xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><path fill="#ADADAD" d="M24.712 10.555L27.154 15H39a3 3 0 0 1 3 3v18a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3V12a3 3 0 0 1 3-3h13.083a3 3 0 0 1 2.629 1.555M40 18a1 1 0 0 0-1-1H8v19a1 1 0 0 0 1 1h30a1 1 0 0 0 1-1zM9 11a1 1 0 0 0-1 1v3h16.872l-1.913-3.482a1 1 0 0 0-.876-.518z" /></svg>
